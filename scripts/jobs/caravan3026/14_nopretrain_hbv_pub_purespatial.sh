...
#SBATCH --job-name=Caravan3026_StefaLandNoPretrain_PureSpatial
#SBATCH --array=0-2
#SBATCH --output=%x_%A_%a.out

# StefaLandDecLSTM architecture trained end-to-end from scratch (no loaded
...
OUT_DIR=${DMG_OUTPUT_ROOT}/Caravan3026/StefaLandNoPretrain/pure_spatial_1998-2008/seed${SEED}/

python ${DMG_REPO}/src/dmg/__main__.py \
    --config-name Caravan3026/StefaLandNoPretrainPUB_PureSpatial \
    seed=${SEED} \
    save_path=$OUT_DIR \
    +out_path=$OUT_DIR \
    +run_dir=$OUT_DIR \
