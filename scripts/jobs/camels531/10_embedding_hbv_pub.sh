...
#SBATCH --job-name=Extended1980_1999_EmbeddingMFFormer_PUB
#SBATCH --array=0-2
...
OUT_DIR=${DMG_OUTPUT_ROOT}/Extended1980_1999_Camels531/EmbeddingMFFormer/PUB/seed${SEED}/

python ${DMG_REPO}/src/dmg/__main__.py \
    --config-name camels531/EmbeddingMFFormerPUB \
    seed=${SEED} \
    save_path=$OUT_DIR \
    +out_path=$OUT_DIR \
    +run_dir=$OUT_DIR \
