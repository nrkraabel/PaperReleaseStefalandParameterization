...
#SBATCH --job-name=Camels531_CondensedDaily_PUB_AsStatics
#SBATCH --array=0-2
...
# Ablation override: +model.nn.ablation_mode=embedding_as_input model.nn.adapter_type=none model.nn.use_residual_lstm=False
...
OUT_DIR=${DMG_OUTPUT_ROOT}/Extended1980_1999_Camels531/Camels_531_condensed_embeddings_daily_asstatics/PUB/seed${SEED}/
